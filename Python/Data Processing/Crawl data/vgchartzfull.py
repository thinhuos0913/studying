...
# It was generated by a scrape of vgchartz.com and creates a dataset based on data from vgchartz.com
...
for page in range(1, pages):
    ...
    game_tags = list(filter(
        lambda x: 'href' in x.attrs and x.attrs['href'].startswith('https://www.vgchartz.com/game/'), # attrs = a
...
df.to_csv("vgsales_scraped.csv", sep=",", encoding='utf-8', index=False)
